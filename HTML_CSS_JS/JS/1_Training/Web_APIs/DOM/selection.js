...
// const p1 = createParagraph('Paragraph 1 - This is a text Paragraph Element', div);
// const p2 = createParagraph('Paragraph 2 - This is a text Paragraph Element', div);
// const p3 = createParagraph('Paragraph 3 - This is a text Paragraph Element', div);
// const p4 = createParagraph('Paragraph 4 - This is a text Paragraph Element', div);
// bodyAppend(div);
...
// document.addEventListener('selectionchange', (e) => {
//   const selectedTxt = sel.anchorNode.nodeValue?.slice(sel.anchorOffset, sel.focusOffset);
//   if (selectedTxt?.length) logs.innerText = `${selectedTxt} - {${selectedTxt.length}}`;
// });
...
//   if (!((i) % 2)) { // add odd elements to selection
//     const rng = new Range();
//     rng.selectNode(p);
//     sel.addRange(rng);
//   }
